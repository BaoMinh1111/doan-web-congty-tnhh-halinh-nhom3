    ...
    <div class="container mt-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo htmlspecialchars($currentCategory['name'] ?? 'Sản phẩm'); ?></li>
            </ol>
        </nav>

        <h2 class="text-primary mb-4 border-bottom pb-2">
            Danh mục: <?php echo htmlspecialchars($currentCategory['name'] ?? 'Sản phẩm'); ?>
        </h2>
        ...
        <div class="row g-4 mb-5">
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 card-product border-0 shadow-sm product-hover">
                            <div class="position-relative p-3 text-center">
                                <img src="/assets/images/products/<?php echo htmlspecialchars($p['image'] ?? 'no-image.jpg'); ?>"
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                <h6 class="card-title fw-bold text-dark text-truncate-2" style="height: 40px;">
                                    <?php echo htmlspecialchars($p['name'] ?? ''); ?>
                                </h6>
                                <p class="text-danger fw-bold fs-5 my-2">
                                ...
                                <div class="mt-auto d-grid gap-2">
                                    ...
                                    <button onclick="openBuyNowPopup(<?php echo $p['id']; ?>, '<?php echo htmlspecialchars($p['name'] ?? '', ENT_QUOTES); ?>', '<?php echo number_format($p['price'] ?? 0); ?>')"
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="fs-5 text-muted">Không có sản phẩm nào trong danh mục này.</p>
