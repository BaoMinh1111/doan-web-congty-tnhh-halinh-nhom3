    ...
    <head>
        ...
        <title>Đặt lại mật khẩu — HàLinhTech</title>
        ...
        <style>
            ...
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .brand-grid { position: absolute; inset: 0; background-image: linear-gradient(rgba(255,255,255,.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,.03) 1px, transparent 1px); background-size: 48px 48px; }
            ...
            .brand-logo-icon { width: 44px; height: 44px; background: linear-gradient(135deg, var(--accent), #ff7043); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 1.2rem; box-shadow: 0 8px 24px rgba(233,69,96,.4); }
            ...
            .brand-middle { position: relative; z-index: 1; flex: 1; display: flex; flex-direction: column; justify-content: center; padding-block: 48px; }
            .brand-tagline { font-size: .72rem; font-weight: 700; letter-spacing: .16em; text-transform: uppercase; color: var(--accent); margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }
            ...
            .pw-tips { margin-top: 32px; display: flex; flex-direction: column; gap: 10px; }
            .pw-tip { display: flex; align-items: center; gap: 10px; color: rgba(255,255,255,.6); font-size: .84rem; }
            .pw-tip i { width: 22px; color: #22c55e; flex-shrink: 0; }
            ...
            .auth-form-panel { display: flex; flex-direction: column; justify-content: center; padding: 48px clamp(32px, 6vw, 80px); background: var(--bg-white); overflow-y: auto; }
            ...
            .alert-error { display: flex; align-items: center; gap: 10px; padding: 13px 16px; border-radius: 12px; font-size: .875rem; margin-bottom: 20px; background: rgba(239,68,68,.08); border: 1px solid rgba(239,68,68,.2); border-left: 3px solid #ef4444; color: #991b1b; }
            ...
            .input-wrap .icon-left { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--text-light); font-size: .9rem; pointer-events: none; }
            .toggle-pass { position: absolute; right: 14px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--text-light); font-size: .9rem; }
            .input-wrap input { width: 100%; padding: 12px 40px 12px 42px; border: 1.5px solid var(--border); border-radius: 12px; font-family: var(--font-body); font-size: .95rem; color: var(--text-dark); background: var(--bg-white); outline: none; transition: var(--transition); }
            ...
            .btn-submit { width: 100%; padding: 13px; border: none; border-radius: 12px; background: linear-gradient(135deg, var(--accent), #c73652); color: #fff; font-family: var(--font-body); font-size: .95rem; font-weight: 600; cursor: pointer; transition: var(--transition); display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 16px rgba(233,69,96,.3); }
    ...
    <div class="auth-layout">
        ...
        <div class="auth-brand">
            ...
            <div class="brand-middle">
                <div class="brand-tagline">Bước cuối cùng</div>
                <h2 class="brand-headline">Tạo mật khẩu<br><em>mới an toàn.</em></h2>
                <p class="brand-desc">Hãy chọn một mật khẩu mạnh để bảo vệ tài khoản của bạn khỏi truy cập trái phép.</p>
                <div class="pw-tips">
                    <div class="pw-tip"><i class="fas fa-check-circle"></i> Tối thiểu 6 ký tự</div>
                    <div class="pw-tip"><i class="fas fa-check-circle"></i> Kết hợp chữ hoa, chữ thường</div>
                    <div class="pw-tip"><i class="fas fa-check-circle"></i> Thêm số và ký tự đặc biệt</div>
                    <div class="pw-tip"><i class="fas fa-check-circle"></i> Không dùng thông tin cá nhân</div>
                </div>
            </div>
        ...
        <div class="auth-form-panel">
            ...
            <div class="auth-form-header">
                <h1>Mật khẩu mới 🔒</h1>
                <p>Nhập và xác nhận mật khẩu mới của bạn bên dưới.</p>
            </div>

            <form class="auth-form" action="index.php?controller=auth&action=postResetPassword" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <span class="toggle-pass" onclick="togglePw('pw1','icon1')">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" name="confirm_password" id="pw2"
                               placeholder="Nhập lại mật khẩu trên" required minlength="6">
                        <span class="toggle-pass" onclick="togglePw('pw2','icon2')">
    ...
    <script>
        ...
        function checkStrength(val) {
            ...
            fill.style.background = colors[score - 1] || '#e8e8f0';
        }
    </script>
    </body>
    </html>